...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        ...
        mSwerveMods = new SwerveModule[] {
            ...
            new SwerveModule(2, Constants.Swerve.Mod2.constants, Constants.Swerve.CAN_STRING),
            new SwerveModule(3, Constants.Swerve.Mod3.constants, Constants.Swerve.CAN_STRING)
        };
